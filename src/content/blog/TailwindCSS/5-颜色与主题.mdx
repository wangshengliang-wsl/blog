...
const themes: Record<string, Theme> = {
  light: {
    ...
    colors: {
      ...
      primaryHover: 'oklch(0.48 0.16 250)',
  ...
  dark: {
    ...
    colors: {
      ...
      primaryHover: 'oklch(0.72 0.16 250)',
...
@theme {
  ...
  --color-primary-hover: var(--theme-primaryHover, oklch(0.48 0.16 250));
  --color-background: var(--theme-background, oklch(1 0 0));
  --color-surface: var(--theme-surface, oklch(0.98 0 0));
  --color-text: var(--theme-text, oklch(0.2 0 0));
  --color-text-secondary: var(--theme-textSecondary, oklch(0.45 0 0));
  --color-border: var(--theme-border, oklch(0.9 0 0));
}
```
