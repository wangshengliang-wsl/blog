---
title: React-router v版本学生管理系统课堂笔记
description: React-router v版本学生管理系统课堂笔记
pubDate: 2025-10-11
toc: true
ogImage: true
category: React
...
# _React-router v6_ 版本学生管理系统课堂笔记

## 快速搭建服务器

这里我们选择使用 _json-server_ 来快速搭建一个服务器

_npm_ 地址：*https://www.npmjs.com/package/json-server*

首先 _npm init_ 初始化一个服务器的目录，然后安装 _json-server_ 依赖，之后创建 _db.json_，该文件就是我们的数据文件
...
因为目前还没有学习组件库，我们选择使用 _Bootstrap_

这里我们使用的模板地址：*https://v3.bootcss.com/examples/starter-template/#*

因为我们用了 _bootstrap_ 相关的样式类，所以我们需要引入 _Bootstrap_，我们这里选择使用 _CDN_ 的方式来引入

*https://www.bootcdn.cn/twitter-bootstrap/*

可以在 _index.html_ 中添加如下的代码
