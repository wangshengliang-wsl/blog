...
description: 从 nvm 迁移到 fnm，解决 Shell 启动耗时问题，提升开发体验
pubDate: 2023-02-25
toc: true
ogImage: true
category: 包管理工具
...
对我最直接的影响是：此前那个 8G 运存的 MacBook Pro 打开 VS Code 的时候，总会因为 Shell 解析太久导致 VS Code 终止解析，最终造成了某些 Plugins（比如 Mercurial 相关插件）无法正常使用。此前吐槽过了，可移步文章：[解决 Unable to resolve your shell environment in a reasonable time](https://github.com/tofrankie/blog/issues/95)。
...
- [用锈化的 fnm 管理 Node.js 版本](https://github.com/tofrankie/blog/issues/96)
- [使用 nvs 管理本地 Node.js 版本](https://github.com/tofrankie/blog/issues/97)
- [从 nvm 迁移到 nvs](https://github.com/tofrankie/blog/issues/98)
